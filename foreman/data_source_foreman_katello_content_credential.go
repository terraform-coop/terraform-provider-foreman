...
func dataSourceForemanKatelloContentCredential() *schema.Resource {
	...
	return &schema.Resource{
		...
		Read: dataSourceForemanKatelloContentCredentialRead,
...
func dataSourceForemanKatelloContentCredentialRead(d *schema.ResourceData, meta interface{}) error {
	...
	queryResponse, queryErr := client.QueryKatelloContentCredential(contentCredential)
	if queryErr != nil {
		return queryErr
	}
